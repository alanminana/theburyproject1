...
namespace TheBuryProject.Controllers
{
    ...
    public class MercadoLibreController : Controller
    {
        ...
        public async Task<IActionResult> AumentoNuevo()
        {
            ...
            {
                Origen = TheBuryProject.Models.Entities.MercadoLibrePriceBatchOrigen.PorcentajeSobrePrecioMl,
        ...
        [ValidateAntiForgeryToken]
        [PermisoRequerido(Modulo = "mercadolibre", Accion = "orders")]
        public async Task<IActionResult> OrdenDevolucion(int id, TheBuryProject.Models.Entities.MercadoLibreDevolucionEstado decision, string? nota)
        {
            try
            {
                await _orderService.DecidirDevolucionAsync(id, decision, nota, User.Identity?.Name ?? "Sistema");

                TempData["Success"] = decision == TheBuryProject.Models.Entities.MercadoLibreDevolucionEstado.StockReingresado
        ...
        [ValidateAntiForgeryToken]
        [PermisoRequerido(Modulo = "mercadolibre", Accion = "orders")]
        public async Task<IActionResult> OrdenSimularClaim(int id, TheBuryProject.Models.Entities.MercadoLibreClaimTipo tipo, string? motivo)
        {
            var config = await _configuracionService.GetAsync();
            var permitirPorDevelopment = _hostEnvironment.IsDevelopment();
        ...
        public async Task<IActionResult> OrdenResolverClaim(
            int id,
            int claimId,
            TheBuryProject.Models.Entities.MercadoLibreClaimAccionStock accionStock,
            TheBuryProject.Models.Entities.MercadoLibreClaimAccionEconomica accionEconomica,
            ...
            string? observaciones)
        {
            try
            {
                ...
                TempData["Success"] = accionStock == TheBuryProject.Models.Entities.MercadoLibreClaimAccionStock.ReingresarStock
        ...
        public async Task<IActionResult> ListingOrigenStock(
            int id, TheBuryProject.Models.Entities.MercadoLibreOrigenStock? origen, int? productoUnidadId)
        {
            try
            {
        ...
        public async Task<IActionResult> ListingVariacionVinculo(
            ...
            long variationId,
            int? productoId,
            TheBuryProject.Models.Entities.MercadoLibreOrigenStock? origen,
